...
| 学号 | 姓名 | 年龄 | 学院   | 院长  | 课程名称 | 成绩 | 学分 |
| ---- | ---- | ---- | ------ | ----- | -------- | ---- | ---- |
| 001  | A    | 20   | 计算机 | 院长1 | 数据结构 | 70   | 2    |
| 002  | B    | 20   | 软件   | 院长2 | 数据结构 | 65   | 2    |
| 001  | A    | 20   | 计算机 | 院长1 | 编译原理 | 80   | 1    |
| 003  | C    | 21   | 计算机 | 院长1 | 编译原理 | 90   | 1    |
...
实现方式：还是拆分表属性，以 2NF 拆分后的表为例。

观察学生信息表，`学号`决定`学院`，学院决定院长，同时学院不能决定学号，学院和院长也不属于学号的一部分，因此院长传递依赖于学号，不符合 3NF。
